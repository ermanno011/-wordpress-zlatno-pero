...
<body>
  <header class="custom reference">
    ...
    <div class="container">
      <nav class=main-nav>
        <div class="logo"><img src="/wp-content/uploads/2020/04/logo.png" alt="Website main logo"></div>
        <ul class="nav-list">
      ...
      <div class="header-content">
        <div class="left-content">
          <img src="/wp-content/uploads/2020/04/reference-header.png" alt="Website main header image">
        </div>
